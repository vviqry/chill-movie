...
function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Pendaftaran berhasil, ${formData.username}! Silakan login.`);
    navigate('/login');
  };

  const handleGoogleRegister = () => {
    alert('Fitur daftar dengan Google sedang dalam pengembangan!');
  };

  return (
    <div className="auth-page" style={{ backgroundImage: 'url(/backgrounda.jpg)' }}>
        ...
        <div className="auth-card">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <p className="auth-login-link">
              Sudah punya akun? <Link to="/login"><strong>Masuk</strong></Link>
            </p>
